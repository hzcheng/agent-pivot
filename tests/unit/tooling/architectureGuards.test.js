...
function copyGuardFixture(t, mutationPath, mutate = source => source) {
    const relativePaths = [
        ...
        'src/aiSessions/conversation/workspaceMarkdownFile.ts',
        'src/aiSessions/conversation/markdownSuggestions.ts',
        'src/aiSessions/conversation/markdownSuggestionState.ts',
        ...
        'src/aiSessions/codexProfileNames.ts',
        ...
        'src/aiSessions/conversation/commandRunner.ts',
        ...
        'src/aiSessions/conversation/documentComments.ts',
        'src/aiSessions/conversation/documentCommentStore.ts',
        'src/aiSessions/conversation/documentCommentController.ts',
