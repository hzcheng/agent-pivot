...
// Harness pruning (2026-08-20): the capability-coverage half rode the deleted
// capability audit. The remaining check validates the behavior catalog
// itself: every entry has existing owner files and literal IDs referenced by
// those owners.
