...
const providers = [{
    ...
    currentShellResume: 'cd "C:\\fixtures\\project folder & 100%" && kimi --resume "session \\"quoted\\" & 100%"',
    emptyResume: 'kimi --resume ""',
    emptyNew: 'kimi',
    markedResume: "kimi --resume 'Owner''s \"quoted\" & 100%'",
    markedNew: "kimi --prompt 'Owner''s \"quoted\" & 100%'",
    usesSpecCwd: true,
}, {
    id: 'claude',
