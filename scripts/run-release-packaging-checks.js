...
const EXPECTED_MAIN_ENTRIES = Object.freeze([
    ...
    'extension/dist/codexTerminal.js',
    ...
    'extension/media/conversationChangesScripts.js',
    'extension/media/conversationReconcileScripts.js',
    'extension/media/conversationSubagentsScripts.js',
    'extension/media/conversationFindScripts.js',
    ...
    'extension/media/fonts/KaTeX_AMS-Regular.woff2',
    'extension/media/fonts/KaTeX_Caligraphic-Bold.woff2',
    'extension/media/fonts/KaTeX_Caligraphic-Regular.woff2',
    'extension/media/fonts/KaTeX_Fraktur-Bold.woff2',
    'extension/media/fonts/KaTeX_Fraktur-Regular.woff2',
    'extension/media/fonts/KaTeX_Main-Bold.woff2',
    'extension/media/fonts/KaTeX_Main-BoldItalic.woff2',
    'extension/media/fonts/KaTeX_Main-Italic.woff2',
    'extension/media/fonts/KaTeX_Main-Regular.woff2',
    'extension/media/fonts/KaTeX_Math-BoldItalic.woff2',
    'extension/media/fonts/KaTeX_Math-Italic.woff2',
    'extension/media/fonts/KaTeX_SansSerif-Bold.woff2',
    'extension/media/fonts/KaTeX_SansSerif-Italic.woff2',
    'extension/media/fonts/KaTeX_SansSerif-Regular.woff2',
    'extension/media/fonts/KaTeX_Script-Regular.woff2',
    'extension/media/fonts/KaTeX_Size1-Regular.woff2',
    'extension/media/fonts/KaTeX_Size2-Regular.woff2',
    'extension/media/fonts/KaTeX_Size3-Regular.woff2',
    'extension/media/fonts/KaTeX_Size4-Regular.woff2',
    'extension/media/fonts/KaTeX_Typewriter-Regular.woff2',
    'extension/media/katex.min.css',
    ...
    'extension/out/attentionSessionKeys.js',
    'extension/out/runtimeOwnership.js',
    'extension/out/sessionAssignment.js',
...
function run() {
    ...
    assert.strictEqual(
        ...
        'npm run test-compile && npm run brand:verify && npm run brand:check && npm run test:behavior-contracts && npm run lint:ci && npm run test:coverage:run && npm run test:conversation-sources:remote && npm run test:conversation-performance && npm run test:managed-remote-performance && npm run test:browser:run && npm run test:safety:run && npm run test:dashboard:run && npm run test:architecture-baseline && npm run test:architecture-guards && npm run test:architecture-policy && npm run test:release-notes && npm run test:release-packaging && node scripts/check-coverage-baseline.js && node scripts/check-changed-coverage.js',
    ...
    for (const requiredArtifact of [
        ...
        'out/worktreeSessionAssignment.js',
