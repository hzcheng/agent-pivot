...
<svg viewBox="0 0 448 512">
    <path d="M433.9 129.9L318.1 14.1C309.1 5.1 296.9 0 284.2 0H48C21.5 0 0 21.5 0 48v416c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V163.8c0-12.7-5.1-24.9-14.1-33.9zM272 48v128H96V48h176zm96 416H80V320h288v144zm32-192H48V48h16v152c0 13.3 10.7 24 24 24h208c13.3 0 24-10.7 24-24V62.6l80 80V272z"></path>
</svg>
`;

export const archive = `
<svg viewBox="0 0 24 24">
    <path d="M4 4h16v4H4V4zm1.5 6h13v9H5.5v-9zm5 2.5v1.5h3v-1.5h-3z"></path>
</svg>
`;
...
<svg viewBox="0 0 576 512">
    <path d="M287.9 17.8l73 148 163.4 23.7c26.2 3.8 36.7 36.1 17.7 54.6L423.7 359.3l27.9 162.7c4.5 26.1-23 46-46.4 33.7L288 494.1 170.8 555.7c-23.4 12.3-50.9-7.6-46.4-33.7l27.9-162.7L34 244.1c-19-18.5-8.5-50.8 17.7-54.6L215.1 165.8l73-148c11.7-23.6 45.9-23.9 57.8 0zM288 70.4L237.5 172.6c-4.7 9.5-13.8 16.1-24.3 17.6L100.5 206.6l81.6 79.6c7.6 7.4 11.1 18.1 9.3 28.6L172.2 427.1l100.8-53c9.4-4.9 20.6-4.9 30 0l100.8 53-19.3-112.3c-1.8-10.5 1.7-21.2 9.3-28.6l81.6-79.6-112.7-16.4c-10.5-1.5-19.6-8.1-24.3-17.6L288 70.4z"></path>
</svg>
`;

export const starFilled = `
<svg viewBox="0 0 576 512">
    <path d="M316.9 18.8l65.7 133.2 147 21.4c26.9 3.9 37.7 37 18.2 56L441.5 333l25.1 146.4c4.6 26.8-23.5 47.3-47.6 34.6L288 445.2 157 514c-24.1 12.7-52.2-7.8-47.6-34.6L134.5 333 28.2 229.4c-19.5-19-8.7-52.1 18.2-56l147-21.4 65.7-133.2c12-24.4 46.8-24.4 58.8 0z"></path>
</svg>
`;
...
export const folder = `
<svg viewBox="0 0 512 512">
    <path d="M464 128H272l-64-64H48C21.5 64 0 85.5 0 112v288c0 26.5 21.5 48 48 48h416c26.5 0 48-21.5 48-48V176c0-26.5-21.5-48-48-48z"></path>
</svg>
`;
...
// Brand icons below are from Simple Icons (https://simpleicons.org), licensed under CC0-1.0.

// OpenAI / ChatGPT (used for the Codex provider)
...
<svg viewBox="0 0 24 24">
    <path d="M3 6h18c.55 0 1 .45 1 1v10c0 .55-.45 1-1 1H3c-.55 0-1-.45-1-1V7c0-.55.45-1 1-1zm2 2v8h2V8H5zm4 0v8h2V8H9zm4 0v8h2V8h-2zm4 0v8h3V8h-3z"></path>
</svg>
`;
...
<svg viewBox="0 0 448 512">
    <path d="M64 32C28.7 32 0 60.7 0 96v320c0 35.3 28.7 64 64 64h320c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm160 128c13.3 0 24 10.7 24 24v48h48c13.3 0 24 10.7 24 24s-10.7 24-24 24h-48v48c0 13.3-10.7 24-24 24s-24-10.7-24-24v-48h-48c-13.3 0-24-10.7-24-24s10.7-24 24-24h48v-48c0-13.3 10.7-24 24-24z"></path>
</svg>
`;
...
/** Collapse-all for worktree rows: two chevrons folding upward. */
export const collapseWorktrees = `
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="m6 11 6-6 6 6"></path>
    <path d="m6 17 6-6 6 6"></path>
</svg>
`;

/** Expand-all for worktree rows: two chevrons opening downward. */
export const expandWorktrees = `
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
